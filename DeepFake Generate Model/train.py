...
if __name__ == '__main__':
    ...
    for step in range(start, total_step):
        ...
        for interval in range(2):
            ...
            img_id_112      = F.interpolate(img_id,size=(112,112), mode='bicubic', align_corners= True)
            ...
            if interval:
                ...
                img_fake_down   = F.interpolate(img_fake, size=(112,112), mode='bicubic', align_corners=True)
        ...
        if (step + 1) % opt.sample_freq == 0:
            ...
            with torch.no_grad():
                ...
                arcface_112     = F.interpolate(src_image2,size=(112,112), mode='bicubic', align_corners=True)
